...
const ResultsDisplay: React.FC<ResultsDisplayProps> = ({
  ...
  return (
    <div className="p-4 bg-gray-50 border border-gray-200 rounded-lg shadow-md space-y-4 text-foreground">
      <h3 className="text-sm font-semibold">Forest Performance Metrics</h3>
      <div>
      ...
      <div>
        ...
        <p className="text-primary font-bold text-sm">{biodiversityImpact.toFixed(2)} / 5</p>
      </div>
      <div>
        <h4 className="font-semibold">Forest Resilience</h4>
        <p className="text-primary font-bold text-sm">{forestResilience.toFixed(2)} / 5</p>
      </div>
    </div>
  );
};
